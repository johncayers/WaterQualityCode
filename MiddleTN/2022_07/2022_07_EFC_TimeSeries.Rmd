...
DataFacetLong <- pivot_longer(DataFacet, names_to = "variable", values_to = "measurement", Temp_C:TAL_PC_RFU)
...
print(p)
ggsave("2022_07_EFC_TimeSeriesV2.svg", path = "Plots")
...
p <- ggplot(PercChangeLong, aes(x = days, y = measurement, color = variable)) +
  theme_bw() +
    ...
    ylab("% change")
print(p)
ggsave("2022_07_EFC_TimeSeriesPercChange.svg", path = "Plots")
